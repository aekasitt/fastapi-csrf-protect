...
@mark.parametrize(
  ...
  ids=[
    ...
    "secret_key-1.0",
    "secret_key-True",
    "secret_key-secret-as-bytes",
    "secret_key-empty-list",
    "secret_key-empty-set",
    "token_location-body-without-token-key",
    "token_location-body-as-bytes-with-token-key",
    "token_location-body-as-bytes-with-token-key",
    "token_location-header-as-bytes",
  ],
)
