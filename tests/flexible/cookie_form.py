...
# FILENAME:    ~~/tests/flexible/cookie_form.py
# VERSION:     1.0.7
...
@mark.parametrize(
    ...
    ids=(
        "flexible-cookie-form",
        "flexible-cookie-form-samesite-lax",
        "flexible-cookie-form-samesite-strict",
    ),
)
def test_submit_csrf_token_in_form_and_cookie(
    ...
    payload: dict[str, str] = (
        {"csrf-token": csrf_token} if csrf_token is not None else {}
    )
...
@mark.parametrize(
    ...
    ids=("flexible-cookie-form-secure-http",),
)
...
@mark.parametrize(
    ...
    ids=(
        "flexible-cookie-form-secure-https",
        "flexible-cookie-form-samesite-lax-secure-https",
        "flexible-cookie-form-samesite-none-secure-https",
        "flexible-cookie-form-samesite-strict-secure-https",
    ),
)
